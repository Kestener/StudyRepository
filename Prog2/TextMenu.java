...
public class TextMenu extends JMenu {
	...
	private JRadioButton leftRadio, rightRadio, centerRadio; // justify options in the text menu.
	...
	private JMenu makeJustifyMenu() {
		...
		ButtonGroup justifyGroup = new ButtonGroup(); // coordinates the buttons on the justify menu
		
		leftRadio = new JRadioButton("Left");
		justifyGroup.add(leftRadio); 				//  Add left button to the ButtonGroup
		leftRadio.addActionListener( new ActionListener() { // ActionListener anonymous class
			public void actionPerformed(ActionEvent evt) {
				panel.getTextItem().setJustify(TextItem.LEFT);
				panel.repaint();
			}
		});
		justify.add(leftRadio);
		
		rightRadio = new JRadioButton("Right");
		justifyGroup.add(rightRadio); 				//  Add right button to the ButtonGroup
		leftRadio.addActionListener( new ActionListener() { // ActionListener anonymous class
			public void actionPerformed(ActionEvent evt) {
		...
		justify.add(rightRadio);
		
		centerRadio = new JRadioButton("Center");
		justifyGroup.add(centerRadio); 				//  Add center button to the ButtonGroup
		leftRadio.addActionListener( new ActionListener() { // ActionListener anonymous class
			public void actionPerformed(ActionEvent evt) {
