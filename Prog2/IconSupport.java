...
public class IconSupport {
	...
	/**
	 * Return a JMenu containing the list of options representing the images that can
	 * be added to the DrawPanel. It is based on the createToolbar method above.
	 * @return all the actions available in the actions ArrayList.
	 */
	public JMenu createMenu() {
		JMenu stamper = new JMenu("Stamper"); // Based on assignment instructions.
		
		for (int i = 0; i < actions.size()-1; i++) // Loops through all the actions in the array.
